...
- this module's skills are still onscreen-only despite being admin-readable; their frontmatter should require the live `agent` skill-context tag so they do not leak into the separate `/admin` agent runtime
