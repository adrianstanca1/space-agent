...
- `watchdog_external_changes_test.mjs`: focused watchdog coverage for raw external nested file creation, CLI-style user and group writes, and completion-anchored backstop reconcile scheduling when periodic full rescans are disabled or slowed
